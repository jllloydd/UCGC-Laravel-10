<x-app-layout>
    ...
    <div class="py-12">
        ...
        <div class="max-w-8xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-gradient-to-b from-emerald-900 via-emerald-600 to-emerald-300 dark:bg-gray-800 overflow-hidden p-4 shadow-lg sm:rounded-lg">
                ...
                <div class="flex-column grid grid-cols-1 gap-6">{{-- cards and tables grid --}}
                    ...
                    <div class="flex-grid grid grid-cols-4"> {{-- info cards --}}
                        ...
                        <div class="bg-white text-dark p-4 m-5 shadow-lg rounded-lg">
